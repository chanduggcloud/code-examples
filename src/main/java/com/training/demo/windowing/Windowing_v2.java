...
public class Windowing_v2 {
    ...
    public static void main(String[] args) {
        ...
        movieTags.apply("Window", Window.into(FixedWindows.of(Duration.standardSeconds(20))))
                ...
                .apply("WriteToFile", TextIO
                        .write()
                        .to("src/main/resources/sink/windowing/v2/fixed_window_output").withSuffix(".csv")
