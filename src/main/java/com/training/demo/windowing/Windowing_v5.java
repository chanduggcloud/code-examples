...
public class Windowing_v5 {
    ...
    public static void main(String[] args) {
        ...
        movieTags.apply("Window", Window.into(Sessions.withGapDuration(Duration.standardSeconds(10))))
                .apply("ToStrings", MapElements
                        .into(TypeDescriptors.strings())
                        .via(mt -> mt.asCSVRow(",")))
                .apply("WriteToFile", TextIO
                        .write()
                        .to("src/main/resources/sink/windowing/v5/session_window_output").withSuffix(".csv")
