...
public class Windowing_v1 {
    ...
    public static void main(String[] args) {
        ...
        movieTags.apply("Window", Window.into(FixedWindows.of(Duration.standardSeconds(5))))
                .apply("ToStrings", MapElements
                        .into(TypeDescriptors.strings())
                        .via(mt -> mt.asCSVRow(",")))
                .apply("WriteToFile", TextIO
                        .write()
                        .to("src/main/resources/sink/windowing/v1/fixed_window_output").withSuffix(".csv")
